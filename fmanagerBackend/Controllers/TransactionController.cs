...
namespace fmanagerBackend.Controllers
{
    public class TransactionController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Sum,Description")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Sum,Description")] Transaction transaction)
        {
